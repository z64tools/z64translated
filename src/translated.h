...
const char* sSpcCharMap[][2] = {
    { "À", "\x80" }, { "î", "\x81" }, { "Â", "\x82" }, { "Ä", "\x83" },
    { "Ç", "\x84" }, { "È", "\x85" }, { "É", "\x86" }, { "Ê", "\x87" },
    { "Ë", "\x88" }, { "Ï", "\x89" }, { "Ô", "\x8A" }, { "Ö", "\x8B" },
    { "Ù", "\x8C" }, { "Û", "\x8D" }, { "Ü", "\x8E" }, { "ß", "\x8F" },
    { "à", "\x90" }, { "á", "\x91" }, { "â", "\x92" }, { "ä", "\x93" },
    { "ç", "\x94" }, { "è", "\x95" }, { "é", "\x96" }, { "ê", "\x97" },
    { "ë", "\x98" }, { "ï", "\x99" }, { "ô", "\x9A" }, { "ö", "\x9B" },
    { "ù", "\x9C" }, { "û", "\x9D" }, { "ü", "\x9E" },
};
